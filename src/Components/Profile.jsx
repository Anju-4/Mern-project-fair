     ...
     <Collapse in={open}>
         <div className='row shadow p-5 justify-content-center mt-4'>
          ...
          <label className='text-center'>
             ...
             { existingImage !==""?<img width={'200px'} height={'200px'} src={preview?preview:`${BASE_URL}/uploads/${existingImage}`} alt="" />:
             <img width={'200px'} height={'200px'} src={preview?preview:`https://cdn-icons-png.flaticon.com/512/3135/3135715.png` }alt="" />}
          </label>
           <div className='mt-3'>
