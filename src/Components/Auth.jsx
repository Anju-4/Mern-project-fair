  ...
  return (
    <div style={{width:'100%',height:'100vh'}} className='d-flex justify-content-center align-items-center'>
       <div className='w-75 container'>
            <Link to={'/'} style={{textDecoration:'none',color:'blue'}}> <i className='fa-solid fa-left-long me-1'></i>Back to Home</Link>
                            ...
                            <Form.Group className='mb-3' controlId='formBasicEmail'>
...

                                {
                                    ...
                                    <div>
                                     ...
                                     <p>New user Account? Click here to <Link to={'/register'}>Register</Link> </p>
                                 </div>
                                }
